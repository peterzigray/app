...
class SvgLogin extends Component {
  render() {
    ...
    return (
	 ...
	 style="enable-background:new 0 0 1076.1 755.2;" xml:space="preserve" className = 'svg'>
...
<path class="st0" d="M509.1,150.3c-24,0-43.5-18.5-43.5-41.3s19.5-41.3,43.5-41.3c24,0,43.5,18.5,43.5,41.3
	C552.5,131.8,533.1,150.3,509.1,150.3z M509.1,68.9c-23.3,0-42.2,17.9-42.2,40.1s18.9,40.1,42.2,40.1c23.3,0,42.2-17.9,42.2-40.1
	C551.2,86.9,532.3,69,509.1,68.9z"/>
<rect x="748.1" y="744.5" class="st0" width="283" height="2"/>
<rect x="485.5" y="99" class="st7" width="105" height="81"/>
<text transform="matrix(1 0 0 1 485.5319 124.6002)" class="st8 st9 st10">NN</text>
<rect x="133" y="109" class="st7" width="70" height="22"/>
</svg>
      </div>
